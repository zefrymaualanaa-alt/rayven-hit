...
bot.start(async (ctx) => {
    ...
    const welcomeText = `<b>[ RAYVEN AUTOMATION SYSTEM ]</b>\n\n` +
        `Selamat datang di sistem otomatisasi RAYVEN. Bot ini berfungsi sebagai mesin extractor otomatis untuk mendapatkan cookies Netflix (Live) secara massal.\n\n` +
